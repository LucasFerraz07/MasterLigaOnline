...
Route::middleware('auth.api', 'permission:club.create')->group(function () {
    Route::post('/', [Club::class, 'store']);
});

Route::middleware('auth.api', 'permission:club.update')->group(function () {
    Route::put('/{id}', [Club::class, 'update']);
});

Route::middleware('auth.api', 'permission:club.delete')->group(function () {
